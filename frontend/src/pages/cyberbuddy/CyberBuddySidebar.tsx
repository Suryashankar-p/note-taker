...
import "./styles.css";
import More from "../../assets/More.tsx";
import DropDownMenu from "../../components/DropdownMenu.tsx";
import Edit from "../../assets/edit.svg";
import Trash from "../../assets/trash.svg";
import ConfirmationModal from "../../components/Modals/ConfirmationModal.tsx";
import { categorizeDate } from "../../utils/functions.ts";
...
const Sidebar: React.FC<Props> = ({
  ...
  const handleChatClick = async (item: any) => {
    ...
    navigate(`/ai-studio/cyberbuddy?chat_id=${item?.id}`);
    if (item.id != chat_id) {
      getPageChat(item.id);
    }
  };
  ...
  return (
    <div className="w-full bg-primary_text flex space-y-2 md:space-y-1 flex-col p-2 md:p-1 mt-16 md:mt-2">
      <Button
      ...
      <Button
        onClick={() => navigate("/ai-studio/cyberbuddy/settings")}
