...
export default function Cost({ usageData, limit, onLimitEdit, month }: any) {
  ...
  return (
    <div className="flex flex-col md:flex-row lg:h-[32rem] xl:h-screen sm:h-[48rem] h-[42rem] lg:flex-row xl:flex-row lg:py-6 py-1 justify-between px-4">
      {editLimit && (
      ...
      <div className="w-full md:w-1/2 lg:w-1/3 flex flex-col lg:flex-row top-1 relative justify-between items-between h-[300px] md:h-[150px] lg:h-[300px]">
        ...
        <div className="absolute flex flex-col items-center lg:-right-8 xl:-right-4 lg:bottom-4 md:bottom-10 -bottom-6 xl:bottom-16 right-[75px] ">
          <Text className="text-xl font-bold text-primary_text">${totalCost}</Text>
          ...
          {CyberBuddyMemberDetails?.role === "OWNER" && (
            <button
              ...
              className="bg-danger rounded-lg p-2 m-2 md:p-2 md:m-4 text-sm md:text-base"
            >
