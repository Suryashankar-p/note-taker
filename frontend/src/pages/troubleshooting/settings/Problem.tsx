...
import FileEditModal from "../../../components/Modals/FileEditModal.tsx";
import { useDispatch, useSelector } from "react-redux";
import { Dispatch, RootState } from "../../../redux/store";
import AddProductModal, {
  DefaultValue,
} from "../../../components/Modals/AddProductModal.tsx";
            ...
            products.map((item: any, key: number) => (
              ...
              >
                ...
                {fileUpload.status && (
                 ...
                 {fileUrl && <FileViewModal fileUrl={fileUrl} isOpen={fileUrl} onClose={() => setFileUrl(null)} />}
              </div>
            ))
          ) : (
