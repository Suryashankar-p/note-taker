    ...
    return (
        <div className='flex h-full py-6 justify-between px-4 flex-row'>
            ...
            <div className='w-1/2 flex relative justify-center items-center'>
                ...
                <div
                    className='absolute top-[10.5rem] left-[108px] flex self-center justify-center items-center text-center text-primary_text w-[100px]'                >
                ...
                <div className='absolute flex flex-col ml-4 top-70 items-center right-2'>
                    ...
                    {salesMemberDetails?.role === 'OWNER' && <button onClick={() => dispatch.modal.openEditLimit()} className='bg-danger rounded-lg p-2 m-2'>
