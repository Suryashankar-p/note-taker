...
import { CreateMember, DeleteMember, ReadMembers, UpdateMember } from '../../../services/doctor_conbot';
import NoData from '../../../assets/no_data';
import Toast from '../../../components/Toast';
import { getDoctorConbotRole } from './Settings';

export const getKeyByValueDoctorConBot = (object: any, value: any) => {
    ...
    <div className="flex flex-col h-full gap-8 overflow-y-hidden">
      ...
      <div className="mx-16 mt-1 flex flex-row justify-between">
        <div className="flex flex-col">
          <Text className="text-[#091E42]" type="header2">Members</Text>
          {data && (
      ...
      <div className="mx-16 mt-2 overflow-y-scroll" ref={scrollContainerRef} onScroll={handleScroll}>
        {data?.length > 0 ? (
          <UserTable data={data} onSubmit={onSubmit} onDeleteSubmit={onDeleteSubmit} handleScroll={handleScroll} />
        ) : (
