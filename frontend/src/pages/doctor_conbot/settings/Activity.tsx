...
export default function Activity({ activityData, month, topUsers, trendData }: Props) {
  ...
  const activeUsersCount =
    activityData?.totalActiveUsers ?? activeUsers.length;

  const avgPerActiveUser =
    activeUsersCount > 0
  ...
  <div className="flex flex-col px-4 py-4 gap-0">
    ...
    <div className="flex flex-row gap-6 min-h-[380px]">
      ...
      {/* RIGHT: Top users with infinite scroll */}
      <div
        className="flex flex-col w-[280px] xl:w-[320px] flex-shrink-0 overflow-y-auto max-h-[380px]"
      >
        <Text className="mb-2 text-lg md:text-xl" type="header3">
          Top Users
        </Text>
