...
const Dollar: React.FC<DollarProps> = ({ disabled, onClick, className, data }) => {
  ...
  return (
    ...
    >
      <svg style={{ fill: isHovered ? '#5661F6' : 'black', fillOpacity: isHovered ? 1 : 0.44 }} xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="#black" fillOpacity={"0.44"} className="bi bi-currency-dollar" viewBox="0 0 14 14">
